...
#
################################################################
# bda - Changed to set SECTORSCOPE_CFLAGS instead of CFLAGS
#       and SECTORSCOPE_CXXFLAGS instead of CXXFLAGS
...
do
  ...
  AC_COMPILE_IFELSE([AC_LANG_PROGRAM([[]], [[]])],
      [has_option=yes; SECTORSCOPE_CFLAGS="$SECTORSCOPE_CFLAGS $option"],
      [has_option=no])
...
do
  ...
  AC_COMPILE_IFELSE([AC_LANG_PROGRAM([[]], [[]])],
      [has_option=yes; SECTORSCOPE_CXXFLAGS="$SECTORSCOPE_CXXFLAGS $option"],
      [has_option=no])
  AC_MSG_RESULT($has_option)
  unset has_option
...
AC_SUBST(SECTORSCOPE_CFLAGS)
AC_SUBST(SECTORSCOPE_CXXFLAGS)
